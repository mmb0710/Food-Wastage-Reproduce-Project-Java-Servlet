...
<body>
    ...
    <div class="logout">
        <form action="LogoutServlet" method="post">
            <input type="submit" value="Logout" class="subscribe-button">
        </form>
    </div>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                <% List<InventoryItem> discountedItems = (List<InventoryItem>) request.getAttribute("discountedItems");
                   if (discountedItems != null) {
                       for (InventoryItem item : discountedItems) { %>
                           <tr>
                               ...
                               <td>
                                   <button class="purchase-button" onclick="purchaseItem('<%= item.getItemId() %>')">Purchase</button>
        ...
        function purchaseItem(itemId) {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    location.reload(); // Reload the page after purchasing the item
                    alert('Item purchased successfully!'); // Display an alert
                }
            };
        }
    </script>
